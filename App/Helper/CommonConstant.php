...
class CommonConstant
{
    ...
    const e_system_no_content = 'success';//'无错误'
    const e_system_general_content = '一般错误';//'一般错误'
    const e_system_in_content = '系统错误';//'系统错误'
    const e_system_config_miss_content = '配置缺少';//'配置缺少'
    const e_system_upload_file_content = '文件上传错误';//'文件上传错误'
    ...
    const e_api_sign_miss_content = '签名参数缺失';//'签名参数缺失'
    const e_api_sign_wrong_content = '接口签名验证失败'; //'接口签名验证失败'
    const e_app_miss_content = 'appid不存在';//'appid不存在'
    const e_app_disabled_content = 'appId已被禁用';//'appId已被禁用'
    ...
    const e_user_disabled_content = '用户已被禁用';//'用户已被禁用'
    const e_user_miss_content = '用户不存在';//'用户不存在'
    const e_user_pass_wrong_content = '用户密码错误';//'用户密码错误'
    const e_user_role_disabled_content = '用户组已被禁用';//'用户组已被禁用'
    const e_api_multiple_device_login_content = '用户在其它设备登录';//'用户在其它设备登录'
    const e_api_user_token_miss_content = '用户访问令牌缺失';//'用户访问令牌缺失'
    const e_api_user_token_expire_content = '用户访问令牌无效或已过期';//'用户访问令牌过期'
    const e_api_user_login_type_content = '用户登录方式错误';//'用户登录方式错误'
